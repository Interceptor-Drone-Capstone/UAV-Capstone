...
int septentrio_main(int argc, char *argv[]);
...
int fw_lat_lon_control_main(int argc, char *argv[]);
int fw_mode_manager_main(int argc, char *argv[]);
...
int sensor_agp_sim_main(int argc, char *argv[]);
...
int system_power_simulator_main(int argc, char *argv[]);
...
void init_app_map(apps_map_type &apps)
{
	...
	apps["septentrio"] = septentrio_main;
	apps["gps"] = gps_main;
	...
	apps["fw_lat_lon_control"] = fw_lat_lon_control_main;
	apps["fw_mode_manager"] = fw_mode_manager_main;
	...
	apps["sensor_agp_sim"] = sensor_agp_sim_main;
	...
	apps["system_power_simulator"] = system_power_simulator_main;
